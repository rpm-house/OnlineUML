 ...
 */
		...
		joint.shapes.erd.Entity = joint.dia.Element
				...
				joint.shapes.erd.MyEntity = joint.shapes.basic.Generic
						.extend({
							markup : [
									'<g class="rotatable">',
									'<g class="scalable">',
									'<rect class="entity-name-rect"/><rect class="entity-attrs-rect"/><rect class="entity-keys-rect"/>',
									"</g>",
									'<text class="entity-name-text"/><text class="entity-attrs-text"/><text class="entity-keys-text"/>',
									"</g>" ].join(""),
							defaults : joint.util.deepSupplement({
								type : "erd.Entity",
								attrs : {
							...
							initialize : function() {
								this.on("change:name change:attributes change:keys",
										function() {
											this.updateRectangles(), this
													.trigger("uml-update")
										}, this), this.updateRectangles(),
										joint.shapes.basic.Generic.prototype.initialize
							...
							updateRectangles : function() {
								...
								_
										.each(
												b,
												function(b) {
													var d = _.isArray(b.text) ? b.text
															: [ b.text ], e = 20 * d.length + 20;
															a[".uml-class-" + b.type
																	+ "-text"].text = d
																	.join("\n"),
															a[".uml-class-" + b.type
				...
				joint.shapes.erd.EntityView = joint.dia.ElementView.extend({
					initialize : function() {
						joint.dia.ElementView.prototype.initialize.apply(this,
								arguments), this.listenTo(this.model, "uml-update",
								function() {
