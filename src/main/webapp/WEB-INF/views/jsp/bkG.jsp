    ...
    var graph, paper;
     ...
     /*  function pickerCallback(data) {
        ...
        if (data[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
          ...
          file = doc[google.picker.Document];
        }
        var url1= url.split("/d/"); 
       // alert("file: "+file)
       // alert("download Url :"+file.downloadUrl)
         alert("url : "+url)
          alert("url1 : "+url1[1])
          var url2 = url1[1].split("/view");
         alert("url2 : "+url2[0])
        var message = 'You picked URL: ' + url + 'You picked Id: ' + id;
      ...
      function printFile(fileId) {
    	...
    	function downloadFile(fileId, callback) {
    		 //var file = "https://www.googleapis.com/drive/v2/files/"+fileId;
