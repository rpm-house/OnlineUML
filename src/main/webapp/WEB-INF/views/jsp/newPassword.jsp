...
<body>
	<spring:url value="/savePassword" var="savePassword" />
	<div id="wrapper">
			...
			<div class="container">
				...
				<ul id="tab">
					<li class="active"><form:form method="post"
							modelAttribute="user" action="${savePassword}">
							...
							<table>
								...
								<tr>
									...
									<td align="left"><input type=text name="recoveryMobile"
										id="recoveryMobile" placeholder="Mobile No"></td>
								</tr>
								<tr>
